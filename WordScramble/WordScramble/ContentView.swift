...
//  WordScramble
//
//  Created by Jason Yang on 29/06/21.
//
...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isNotSame(word: answer) else {
            wordError(title: "Word is the same", message: "You can't just use the start word, you know!")
            return
        }
    ...
    func calculateScore(word: String) {
        let score = word.count + usedWords.count
        currentScore += score
    }
